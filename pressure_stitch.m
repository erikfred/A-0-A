% pressure_stitch.m
%
% Removes calibration intervals from A-0-A pressure data, stitches time
% series together via interpolation, decimates and filters data.
%
...
for i=i_list'
    ...
    save(['../stitched_data/' POBS_dir(i).name],'dataf')
    ...
    save(['../stitched_data/stitched_1Hz/' POBS_dir(i).name(1:end-4)],'data')
    ...
    print(['../figures/stitching/' POBS_dir(i).name(1:end-4) '_stitched'],'-dpng','-r300')
end